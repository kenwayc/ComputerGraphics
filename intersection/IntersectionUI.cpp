...
void IntersectionUI::changeShape( ShapesUI::ShapeType type )
{
    ...
    switch ( type ) {
    case ShapesUI::SHAPE_SPHERE : current = new Sphere(20, 20);
		break;
    case ShapesUI::SHAPE_CYLINDER : current = new Cylinder(20, 1);
		break;
    case ShapesUI::SHAPE_CONE : current = new Cone(20, 1);
		break;
    case ShapesUI::SHAPE_CUBE : current = new Cube(20);
		break;
    }
}
