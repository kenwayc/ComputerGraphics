...
private:
	...
	void drawFlatLine(Color col, int x0, int y0, int x1, int y1); //slope >= -1 and <=1
    void drawSteepLine(Color col, int x0, int y0, int x1, int y1); //slope < -1 or slope > 1
	void fillLine(Color col, int x00, int y00, int x01, int y01, int x10, int y10, int x11, int y11);
