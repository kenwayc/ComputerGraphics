...
void ShapesUI::changedTessel( ) {
	...
	case SHAPE_CYLINDER: 
		current = new Cylinder( shapesUI->getTessel1(), shapesUI->getTessel2() ); 
		break;
	case SHAPE_CONE:
		current = new Cone( shapesUI->getTessel1(), shapesUI->getTessel2());
		break;
	case SHAPE_SPHERE:
		current = new Sphere(shapesUI->getTessel1(), shapesUI->getTessel2());
		break;
	case SHAPE_CUBE:
		current = new Cube( shapesUI->getTessel1());
		break;
	case SHAPE_SPECIAL1:
		current = new Special1( shapesUI->getTessel1(), shapesUI->getTessel2());
		break;
	case SHAPE_SPECIAL2:
		current = new Special2( shapesUI->getTessel1(), shapesUI->getTessel2());
		break;
	default:
		current = 0; break;
	}
